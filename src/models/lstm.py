...
def create_lstm(input_shape: Tuple[int, int] = (100, 6),
                num_classes: int = 5,
...
def create_bidirectional_lstm(input_shape: Tuple[int, int] = (100, 6),
...
def create_gru(input_shape: Tuple[int, int] = (100, 6),
               num_classes: int = 5) -> keras.Model:
